...
<?php
  ...
  try {
    ...
    foreach($products as $product) {
      ...
      echo "<form class='delete-form' method='POST' action='./products/delete.php' onsubmit='return confirm(\"Are you sure you want to delete this product? This action cannot be undone.\")'>";
