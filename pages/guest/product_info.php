    ...
    <footer>
        <div class="footer-container">
            <div class="footer-section">
                <h4>Company Info</h4>
                <ul>
                    <li><a href="revaux/pages/guest/about_company.html">About Revaux</a></li>
                    <li><a href="revaux/pages/guest/about_company.html">Our Story</a></li>
                    <li><a href="revaux/pages/guest/about_company.html">The Revaux Aesthetic</a></li>
                    <li><a href="revaux/pages/guest/about_company.html">Press & Media</a></li>
                </ul>
            </div>
            <div class="footer-section">
                <h4>Help & Support</h4>
                <ul>
                    <li><a href="revaux/pages/guest/faqs.html">Frequently Asked Questions</a></li>
                    <li><a href="revaux/pages/guest/faqs.html">Order Assistance</a></li>
                    <li><a href="revaux/pages/guest/faqs.html">Returns & Exchanges</a></li>
                    <li><a href="revaux/pages/guest/faqs.html">Product Information</a></li>
                </ul>
            </div>
        ...
        <div class="footer-bottom">
            ...
            <div class="footer-links">
                <a href="revaux/pages/guest/terms_conditions.html">Terms & Conditions</a>
                <span class="separator">|</span>
                <a href="revaux/pages/guest/privacy_policy.html">Privacy Policy</a>
            </div> 
        </div>
    </footer>
    <!-- JS -->
